...
public class NewAuction extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	minimumRaise=StringEscapeUtils.escapeJava(request.getParameter("minimumRise"));
        	deadlineDate = StringEscapeUtils.escapeJava(request.getParameter("deadlineLocalDateTime"));
        	selectedItems = request.getParameterValues("dynamicCheckbox");
